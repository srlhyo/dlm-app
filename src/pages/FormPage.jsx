  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* === FOLHAS === */}
        <path
          d="M 155 285 Q 122 268 104 278 Q 124 282 118 295 Q 132 270 155 285Z"
          fill="#8B9E76"
          opacity="0.52"
        />
        <path
          d="M 155 285 Q 188 270 200 280 Q 182 285 180 298 Q 165 272 155 285Z"
          fill="#9CAF88"
          opacity="0.48"
        />
        <path
          d="M 112 218 Q 82 202 68 212 Q 84 216 80 228 Q 92 210 112 218Z"
          fill="#8B9E76"
          opacity="0.5"
        />
        <path
          d="M 222 128 Q 198 115 188 124 Q 202 128 198 140 Q 208 122 222 128Z"
          fill="#9CAF88"
          opacity="0.46"
        />
        <path
          d="M 275 88 Q 252 76 242 84 Q 256 88 252 100 Q 262 84 275 88Z"
          fill="#8B9E76"
          opacity="0.44"
        />
        <path
          d="M 78 162 Q 56 148 46 156 Q 60 160 56 172 Q 66 156 78 162Z"
          fill="#9CAF88"
          opacity="0.46"
        />
        <path
          d="M 48 98 Q 28 86 20 94 Q 34 98 30 108 Q 38 94 48 98Z"
          fill="#8B9E76"
          opacity="0.42"
        />
        <path
          d="M 358 68 Q 340 58 332 65 Q 344 69 340 78 Q 350 65 358 68Z"
          fill="#9CAF88"
          opacity="0.38"
        />
          ...
          {Array.from({ length: 14 }, (_, i) => {
            ...
            return (
              <ellipse
                ...
                rx="15"
                ry="26"
                fill={i % 2 === 0 ? "#F9F5EF" : "#F2EAE0"}
                opacity={0.93 - i * 0.005}
          ...
          {Array.from({ length: 12 }, (_, i) => {
            ...
            return (
              <ellipse
                ...
                rx="13"
                ry="22"
                fill={i % 2 === 0 ? "#F9F5EF" : "#F1E9DF"}
                opacity={0.91 - i * 0.005}
          ...
          <g key={idx} transform={`translate(${x},${y})`}>
            {Array.from({ length: 6 }, (_, i) => {
              ...
              return (
                <ellipse
                  key={i}
                  cx={Math.sin(rad) * r * 0.58}
                  cy={-Math.cos(rad) * r * 0.58}
                  rx={r * 0.44}
                  ry={r * 0.68}
                  fill="#F1E9DF"
                  opacity={0.78}
          ...
          <g key={i}>
            {Array.from({ length: 5 }, (_, j) => {
              ...
              return (
                <ellipse
                  key={j}
                  cx={x + Math.sin(rad) * (r + 2.2)}
                  cy={y - Math.cos(rad) * (r + 2.2)}
                  rx={r * 0.55}
                  ry={r * 0.78}
                  fill="white"
                  opacity="0.93"
